...
public class Main {
    ...
    public static void main(String[] args) {
        try {
            Scanner sc = new Scanner(new File("D://algos//ind3_test//src//in.txt"));
            int N = sc.nextInt();
            ...
            sc.close();
            FileWriter fw = new FileWriter("D://algos//ind3_test//src//out.txt");
            fw.write(Long.valueOf(arrCost[0]).toString());
            fw.write("\n");
