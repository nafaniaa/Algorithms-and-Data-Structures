...
public class MosquitoProblem {

    public static int calculateMaxMosquitoes(ArrayList<Integer> list, int n) {
        if (n == 1) {
            return list.get(0);
        }
        if (n == 2) {
        ...
        sum.add(0); // Placeholder for index 0
        sum.add(list.get(0)); // First mosquito count
        sum.add(-1); // Placeholder for index 2
    ...
    public static ArrayList<Integer> findOptimalRoute(ArrayList<Integer> list, int n) {
        ...
        ArrayList<Integer> sum = new ArrayList<>(n + 1);
        sum.add(-2); // Placeholder for index 0
        sum.add(list.get(0)); // First mosquito count
        sum.add(-1); // Placeholder for index 2
    ...
    public static void main(String[] args) {
        ...
        int maxMosquitoes = calculateMaxMosquitoes(mosquitoes, n);
